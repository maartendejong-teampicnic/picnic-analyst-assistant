...
```bash
~/Documents/Claude/analysistant/skills/gdrive/gdrive.sh <command>
```
...
~/Documents/Claude/analysistant/skills/gdrive/gdrive.sh list

# Find all documents with "usuals" in the name or content
~/Documents/Claude/analysistant/skills/gdrive/gdrive.sh search "usuals"

# List recently shared files
~/Documents/Claude/analysistant/skills/gdrive/gdrive.sh shared

# Read a specific document
~/Documents/Claude/analysistant/skills/gdrive/gdrive.sh read 1BxiMVs0XRA5nFMdKvBdBZjgmUUqptlbs74OgVE2upms

# Show folder tree 2 levels deep
~/Documents/Claude/analysistant/skills/gdrive/gdrive.sh tree --depth 2 --ids
```
