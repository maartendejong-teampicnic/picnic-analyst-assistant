...
```bash
~/picnic-analyst-assistant/skills/slides/slides.sh <deck.json>
```
...
5. Run: `~/picnic-analyst-assistant/skills/slides/slides.sh ~/.claude/data/Input/<deck_name>.json`
...
~/picnic-analyst-assistant/skills/slides/slides.sh ~/.claude/data/Input/my_deck.json

# Build with inline JSON (simple decks)
~/picnic-analyst-assistant/skills/slides/slides.sh --json '{"output": "~/out.pptx", "slides": [...]}'
```
...
```bash
~/picnic-analyst-assistant/skills/slides/thinkcell.sh <deck.json>
```
