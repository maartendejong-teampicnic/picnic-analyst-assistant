...
**Output folder:** create `~/Documents/Claude/analysistant/direct/{username_prefix}-YYYYMMDD-HHMM-analyst-<slug>/`
...
7. Save the approved query as `<descriptive_name>.sql` to `~/Documents/Claude/analysistant/tasks/<task-id>/`
