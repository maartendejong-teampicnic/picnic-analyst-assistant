...
**Output folder:** create `~/picnic-analyst-assistant/direct/{username_prefix}-YYYYMMDD-HHMM-designer-<slug>/`
...
5. Save generated .excalidraw files to `~/picnic-analyst-assistant/tasks/<task-id>/` (same folder as the task context file)
