@~/Documents/Claude/analysistant/agents/ORCHESTRATOR.md
...
2. Read `~/Documents/Claude/analysistant/user-config.md` to get `username_prefix`.

3. Read `~/Documents/Claude/analysistant/TASKS.md` to identify the target task(s).
